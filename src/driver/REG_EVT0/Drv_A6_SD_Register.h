...
*   File       : DRV_SD_Register.h
*   Date       : 2020-07-31 11:32
*
*   THIS CODE IS GENERATED FROM APACHE6 HSI Document. DO NOT EDIT.
********************************************************************************/

#ifndef DRV_REGISTER_SD_H__
#define DRV_REGISTER_SD_H__

#define APACHE_SD_BASE_ADDR        0x0A000000           /* 0x35000000 */
...
typedef struct
{
    ...
    union { /* 0x00FE [Excel Line :0326]  */
        UINT16 Reg;
        struct {
            UINT16 SPEC_VERSION_NUM                                                       : 8;      /* [  7:0] Specification Version Number
    ...
    UINT8 EMPTY6[1024]; /* 0x400 */

    union { /* 0x0500 [Excel Line :0328]  */
        UINT32 Reg;
        struct {
    ...
    UINT8 EMPTY8[27]; /* 0x1B */

    union { /* 0x052C [Excel Line :0341]  */
        UINT16 Reg;
        struct {
    ...
    UINT8 EMPTY10[2596]; /* 0xA24 */

    union { /* 0x0F6C [Excel Line :0374]  */
        UINT32 Reg;
        struct {
...
#endif /* end of  __DRV_REGISTER_SD__ */
