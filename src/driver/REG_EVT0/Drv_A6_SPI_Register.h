...
*   File       : DRV_SPI_Register.h
*   Date       : 2020-07-31 11:32
*
*   THIS CODE IS GENERATED FROM APACHE6 HSI Document. DO NOT EDIT.
********************************************************************************/

#ifndef DRV_REGISTER_SPI_H__
#define DRV_REGISTER_SPI_H__

#define APACHE_SPI_BASE_ADDR1        0x06208000U
#define APACHE_SPI_BASE_ADDR2        0x0620C000U
#define APACHE_SPI_BASE_ADDR3        0x06210000U
...
typedef struct
{
    ...
    union { /* 0x0100 [Excel Line :0092]  */
        UINT32 Reg;
        struct {
            UINT32 APB_SLV_ERR_EN                                                         : 1;      /* [    0] APB Slave Error Enable
                                                                                                               0x0  APB slave error disconnect
                                                                                                               0x1  APB slave error connect */
            UINT32 RESERVED1                                                              : 31;     /* [ 31:1]  */
        }Bit;
    }APB_SLV_ERR_EN;
    ...
    union { /* 0x0110 [Excel Line :0094]  */
        UINT32 Reg;
        struct {
            UINT32 CSN_SEL                                                                : 1;      /* [    0] Slave Select Manual Control Mode Enable
                                                                                                               0x0  Use output of SPI as Slave Select signal
    ...
    UINT8 EMPTY4[108]; /* 0x6C */

    union { /* 0x0180 [Excel Line :0098]  */
        UINT32 Reg;
        struct {
            UINT32 MS_SEL                                                                 : 1;      /* [    0] MasterSlave Select
                                                                                                                Must be set first of all registers
                                                                                                               0x0  Master mode
                                                                                                               0x1  Slave mode */
            UINT32 RESERVED1                                                              : 31;     /* [ 31:1]  */
        }Bit;
...
/*
 static volatile DRV_SPI_REGISTER* const RegA6_SPI[3] = {(DRV_SPI_REGISTER*)APACHE_SPI_BASE_ADDR1, (DRV_SPI_REGISTER*)APACHE_SPI_BASE_ADDR2, (DRV_SPI_REGISTER*)APACHE_SPI_BASE_ADDR3, };
 */



#endif /* end of  DRV_REGISTER_SPI__ */
